Object.keys=Object.keys||function(o){var name,result=[];for(name in o){if(o.hasOwnProperty(name)){result.push(name);}}
return result;}
Base64=(function(){var _PADCHAR="=",_ALPHA="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",_VERSION="1.0";var _getbyte64=function(s,i){var idx=_ALPHA.indexOf(s.charAt(i));if(idx===-1){throw"Cannot decode base64";}
return idx;}
